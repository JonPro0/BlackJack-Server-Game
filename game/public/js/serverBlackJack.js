...
const showCreatedCard = () => {
    if(isPlayable1){
        showCreatedCardPlayer1()
    } else if(isPlayable2){
        showCreatedCardPlayer2()
    } else if(isPlayable3){
        showCreatedCardPlayer3()
    } else if(isPlayable4){
        showCreatedCardPlayer4()
    }
}
